...
int go_cursor_get_next_string(DBC *dbcp, char *key, char *value)
{
        int ret;
        DBT dkey, data;
...
int go_cursor_get_next(DBC *dbcp, DBT *key, DBT *value)
{
        int ret;
        ...
        if ((ret = dbcp->c_get(dbcp, key, value, DB_NEXT)) != 0)
        {
                return ret;
        }
...
int go_cursor_get_prev_string(DBC *dbcp, char *key, char *value)
{
        int ret;
        DBT dkey, data;
...
int go_cursor_get_prev(DBC *dbcp, DBT *key, DBT *value)
{
        int ret;
        ...
        if ((ret = dbcp->c_get(dbcp, key, value, DB_PREV)) != 0)
        {
                return ret;
        }
...
int go_cursor_get_first_string(DBC *dbcp, char *key, char *value)
{
        int ret;
        DBT dkey, data;
...
int go_cursor_get_first(DBC *dbcp, DBT *key, DBT *value)
{
        int ret;
...
int go_cursor_get_last_string(DBC *dbcp, char *key, char *value)
{
        int ret;
        DBT dkey, data;
...
int go_cursor_get_last(DBC *dbcp, DBT *key, DBT *value)
{
        int ret;
        ...
        if ((ret = dbcp->c_get(dbcp, key, value, DB_LAST)) != 0)
        {
                return ret;
        }
